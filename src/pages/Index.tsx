...
import { Printer, FileText, Wrench, Film, Coffee, Stamp, Package, Zap, Cpu, Users } from "lucide-react";
...
const services = [
  ...
  },
  {
    icon: FileText,
    title: "Laminating",
    description: "Protect your important documents with our durable lamination service.",
    pricing: [
  ...
  },
  {
    icon: Wrench,
    title: "Typesetting",
    description: "Professional document formatting and design for resumes, reports, and more.",
    pricing: [
  ...
  },
  {
    ...
    description: "A curated collection of entertainment media for your leisure.",
    pricing: [
  ...
  },
  {
    icon: Coffee,
    title: "Mug Printing",
    description: "Personalize mugs with your favorite photos and designs. Perfect for gifts!",
    pricing: [
  ...
  },
  {
    icon: Stamp,
    title: "Seal Cutting",
    description: "Custom rubber stamps and seals for official and personal use.",
    pricing: [
...
const advantages = [
  ...
  },
  {
    ...
    description: "Friendly and knowledgeable staff to help you with your projects.",
  },
];
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-poppins font-bold text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-foreground mb-6 animate-flicker">
            <span className="bg-gradient-fire bg-clip-text text-transparent">Agni</span> Bookshop
            <br />
            <span className="text-4xl sm:text-5xl md:text-6xl">& Communication</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Your One-Stop Hub for Digital & Physical Solutions. <br />
            <span className="text-primary font-semibold">Igniting Your Ideas.</span>
          </p>
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-10">
            <div>
              <h3 className="font-poppins font-semibold text-2xl mb-4 text-foreground">Contact Information</h3>
              <div className="space-y-4">
                ...
                >
                  <div className="w-12 h-12 rounded-full flex items-center justify-center bg-[#1877F2]/10 group-hover:bg-[#1877F2]/20 transition-colors">
                    <svg className="w-6 h-6 text-[#1877F2]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <div className="pt-2">
              <p className="text-muted-foreground text-lg leading-relaxed">
                Visit us today or reach out through phone, email, or your favorite social channel. We're committed to providing you with fast, reliable, and professional services for all your printing, design, and entertainment needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-6 mb-6">
              <a href="tel:00725451111" className="text-muted-foreground hover:text-primary transition-colors">
                072 545 1111
              </a>
              <span className="text-border">|</span>
              <a href="mailto:agnibookshop@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                agnibookshop@gmail.com
              </a>
            </div>
            
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Agni Bookshop & Communication. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
