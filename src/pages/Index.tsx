...
import { getCombinedSchema } from '@/utils/structuredData';
...
const Index = () => {
  ...
  return (
    <>
      <SEO
        title="Agni Bookshop & Communication - Professional Printing, Laminating & Digital Services in Sri Lanka"
        description="Leading printing & communication center in Sri Lanka. Offering photocopy, color printing, laminating, mug printing, seal cutting, mobile reloads, bill payments & more. Fast, reliable, affordable services. Call 0725451111"
        keywords="printing services Sri Lanka, photocopy near me, laminating services, color printing, black and white printing, mug printing, seal cutting, rubber stamps, mobile reloads, bill payments, typesetting, document formatting, stationery shop, computer accessories, professional printing, fast printing service, Agni bookshop, communication center"
        canonicalUrl="https://agnibookshop.com/"
        structuredData={getCombinedSchema()}
      />
      <div className="min-h-screen bg-black text-white font-inter">
        {/* Hero Section */}
        <section
          className="hero-section relative min-h-[120vh] flex items-center justify-center overflow-hidden bg-black pt-20"
          aria-label="Hero section - Welcome to Agni Bookshop"
          style={{
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center -mt-32">
            ...
            <div className="mb-8 flex justify-center">
              <a
                ...
                aria-label="Call us at 072 545 1111"
                itemProp="telephone"
              >
                <svg
        ...
        <section
          className="py-20 px-4 sm:px-6 lg:px-8 bg-black border-y border-primary/15"
        ...
        {galleryImages.length > 0 && (
          ...
          >
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-white/75 text-center mb-12 text-lg">
                A glimpse into our vibrant workspace and the creations we bring
                to life.
              </p>
            ...
            <div className="max-w-3xl mx-auto space-y-10">
              <div>
                ...
                >
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 text-lg text-muted-foreground hover:text-primary transition-colors group"
                    itemProp="email"
                    aria-label="Email us at agnibookshop1@gmail.com"
                  >
                    <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                      <svg
                        className="w-6 h-6 text-primary"
              ...
              <div className="pt-2">
                <p className="text-white/75 text-lg leading-relaxed">
                  ...
                  fast, reliable, and professional services for all your
                  printing, design, and entertainment needs.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Footer */}
        <footer
          className="bg-black border-t border-primary/20 py-16 px-4 sm:px-6 lg:px-8"
          role="contentinfo"
          itemScope
          ...
          <div className="max-w-7xl mx-auto text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-neutral-200">
              <a
                ...
                itemProp="telephone"
                aria-label="Call 072 545 1111"
              >
                072 545 1111
              </a>
              <span
                className="hidden sm:inline-flex text-neutral-500"
                aria-hidden="true"
              >
                |
              </span>
              <a
                ...
                className="transition-colors duration-200 hover:text-primary"
                itemProp="email"
                aria-label="Email agnibookshop1@gmail.com"
              >
